...
function UserCard({ userData, loading, error }) {
  if (loading) {
    return <Loader />;
  }
  ...
  return (
    <div className="w-full flex justify-center min-h-40">
      <div className="border rounded-2xl border-[#323638] w-3/5 flex gap-x-10 p-4">
        ...
        <div className="text-orange-500 flex flex-col gap-y-4 w-full">
